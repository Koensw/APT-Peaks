"""
Main file to read file and run identification
"""
...
def enable_debug():
    """Enable several debugging options"""
...
def main():
    """Reads epos file and returns peak positions and figure with spectrum and scales"""
    ...
    _, axarr = plt.subplots(2, sharex=True, num=1)
    ...
    for rdg in peak_info:
        ...
        axarr[0].axvspan((mass[rdg['loc']]-scales[rdg['max_row']]),
                         (mass[rdg['loc']]+scales[rdg['max_row']]), color='y')
